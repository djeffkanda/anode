...
class Patience(EarlyStopper):
    ...
    def __init__(self, patience=10, use_train_loss=True, model=None, delta=1e-4):
    ...
    def stop(self, epoch, val_loss, val_auc=None, test_loss=None, test_auc=None, test_ap=None, test_f1=None,
        ...
        if self.use_train_loss:
            if self.local_val_optimum - train_loss > self.delta:
                self.counter = 0
            ...
            if self.local_val_optimum - val_loss > self.delta:
                self.counter = 0
